            ...
            <div class="col-lg-6 position-relative order-lg-2">
                ...
                <div class="overlap-grid overlap-grid-2">
                    <div class="item">
                        ...
                        <figure class="rounded shadow d-none d-md-block"><img src="./assets/img/rover-aboutus.jpg "
                                srcset="./assets/img/rover-aboutus.jpg  2x" alt=""></figure>
                    </div>
                    <div class="item">
                        <figure class="rounded shadow"><img src="./assets/img/bmw-aboutus.jpg"
                                srcset="./assets/img/bmw-aboutus.jpg 2x" alt=""></figure>
                    </div>
                </div>
            </div>
            <!--/column -->
    ...
    <div class="container pt-18 pb-14 pt-md-19 pb-md-16">
        <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center">
            <div class="col-md-8 col-lg-6 offset-lg-0 col-xl-5 offset-xl-1 position-relative">
                ...
                <figure class="rounded d-none d-md-block"><img src="./assets/img/key-aboutus.jpg"
                        srcset="./assets/img/key-aboutus.jpg 2x" alt="">
                </figure>
            </div>
            <!--/column -->
            <div class="col-lg-6">
